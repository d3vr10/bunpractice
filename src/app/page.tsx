...
import promptGeneratorHeadingImage from "../../public/images/prompt_generator_heading.svg";
...
export default function PromptGenerator() {
  ...
  return (
    <div className="flex flex-col">
      <div className="">
        <Image src={promptGeneratorHeadingImage} alt="Imagen de encabezado del generador de prompts" />
      </div>
